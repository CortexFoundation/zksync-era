...
/// The task will archive the `dead` prover records that have not been updated for a certain amount
/// of time. Note: These components speed up provers, in their absence, queries would become sub
/// optimal.
#[derive(Debug)]
