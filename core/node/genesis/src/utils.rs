        ...
        .flat_map(|(tx_index, (_, storage_logs))| {
            storage_logs
                ...
                .map(move |(log_index, storage_log)| {
                    MultiVmLogQuery {
                        // Monotonically increasing Timestamp. Normally it's generated by the VM,
                        // but we don't have a VM in the genesis block.
...
// The code of the bootloader should not be deployed anywhere anywhere in the kernel space (i.e.
// addresses below 2^16) because in this case we will have to worry about protecting it.
