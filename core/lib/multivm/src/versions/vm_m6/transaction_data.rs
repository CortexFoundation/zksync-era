...
/// coefficients.ergs_limit_overhead_coefficient` MUST result in an integer number
...
pub fn get_amortized_overhead(
    ...
    // body of the transaction does not have any more than `MAX_L2_TX_GAS_LIMIT` ergs available to
    // it.
