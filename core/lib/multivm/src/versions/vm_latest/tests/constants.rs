/// Some of the constants of the system are implicitly calculated, but they may affect the code and
/// so we added additional checks on them to keep any unwanted changes of those apparent.
#[test]
