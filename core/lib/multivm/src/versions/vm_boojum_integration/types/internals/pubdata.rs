...
impl PubdataInput {
    pub(crate) fn build_pubdata(self, with_uncompressed_state_diffs: bool) -> Vec<u8> {
        ...
        // Format: `[(numberOfMessages as u32) || (messages[1].len() as u32) || messages[1] || ...
        // || (messages[n].len() as u32) || messages[n]]`
        ...
        // Encoding bytecodes
        // Format: `[(numberOfBytecodes as u32) || (bytecodes[1].len() as u32) || bytecodes[1] ||
        // ... || (bytecodes[n].len() as u32) || bytecodes[n]]`
        ...
        // Format: `[size of compressed state diffs u32 || compressed state diffs || (# state diffs:
        // initial + repeated) as u32 || sorted state diffs by <index, address, key>]`
...
mod tests {
    ...
    fn test_basic_pubdata_building() {
        ...
        // One with enumeration index present (and so it is a repeated write) and the one without
        // it.
        let state_diffs = vec![
            StateDiffRecord {
                address: addr2,
        ...
        assert_eq!(
            hex::encode(pubdata),
            ""
        );
    }
}
