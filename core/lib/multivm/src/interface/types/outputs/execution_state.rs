...
pub struct CurrentExecutionState {
    ...
    pub cycles_used: u32,
    /// Sorted & deduplicated events logs for batch. Note, that this is a more "low-level"
    /// representation of the `events` field of this struct TODO(PLA-649): refactor to remove
    /// duplication of data.
